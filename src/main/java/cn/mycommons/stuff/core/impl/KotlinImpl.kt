package cn.mycommons.stuff.core.impl

import cn.mycommons.stuff.core.*
    ...
    private fun doAddAnnotation() {
        ...
        propertyList.forEachIndexed { index, property ->
            ...
            if (annotation == null) {
                ...
                val text = jsonType.genAnnotationText(GenParam(FileType.KotlinFile, index, name))
                val entry = psiFactory.createAnnotationEntry(text)
